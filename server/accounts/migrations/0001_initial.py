    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('resumes', models.ManyToManyField(blank=True, related_name='user_resume', to='accounts.RunnerResume')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='author_reviewer', to='accounts.accountuser')),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviwer_profile', to='accounts.runnerprofile')),
            ],
            options={
                'ordering': ('created',),
            },
