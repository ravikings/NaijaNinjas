# Generated by Django 4.0 on 2021-12-29 02:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_a_runner",
                    models.BooleanField(default=False, verbose_name="is_a_runner"),
                ),
                (
                    "groups",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "location",
                    models.CharField(
                        blank=True, db_index=True, max_length=55, null=True
                    ),
                ),
                (
                    "salary",
                ...
                (
                    "review",
                    models.ManyToManyField(
                        blank=True, related_name="buyers_review", to="accounts.Review"
                    ),
                ),
                (
                    "views",
                    models.ManyToManyField(
                        blank=True, related_name="user_views", to="accounts.IpModel"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "video",
                    models.FileField(blank=True, upload_to="documents/video/%Y/%m/%d/"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "accomplishment",
                    models.CharField(blank=True, db_index=True, max_length=55),
                ),
                (
                    "career_profile",
                    models.CharField(blank=True, db_index=True, max_length=255),
