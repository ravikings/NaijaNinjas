    ...
    if request.user.is_authenticated:
        if request.method == "POST":
            ...
            if sign_number:
                ...
                # create user
                myuser = AccountUser.objects.create_user(
                    sign_email, sign_email, sign_number
                )
                ...
                var_RunnerProfile = RunnerProfile(
                    author=myuser,
                    ...
                    state=State,
                    city=City,
                    local_goverment_zone=local_government_zone,
                    phone_number = sign_number
                )
                ...
                context = {
                    ...
                    "City": City,
                    "Address": Address,
                    "local_government_zone": local_government_zone,
                }
