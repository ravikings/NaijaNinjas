      ...
      <aside id="accordion1" className="sticky-top sidebar-filter bg-white">
        <Accordion defaultActiveKey="0">
            ...
            <div id="companies" className="acod-body collapse show">
              <div className="acod-content">
                <div className="custom-control custom-checkbox">
                  ...
                  />
                  <label className="custom-control-label" htmlFor="companies1">
                ...
                <div className="custom-control custom-checkbox">
                  <input
                    ...
                    name="checkbox-companies"
                  />
                  <label className="custom-control-label" htmlFor="companies2">
                ...
                <div className="custom-control custom-checkbox">
                  <input
                    ...
                    name="checkbox-companies"
                  />
                  <label className="custom-control-label" htmlFor="companies3">
                ...
                <div className="custom-control custom-checkbox">
                  <input
                    ...
                    name="checkbox-companies"
                  />
                  <label className="custom-control-label" htmlFor="companies4">
                ...
                <div className="custom-control custom-checkbox">
                  <input
                    ...
                    name="checkbox-companies"
                  />
                  <label className="custom-control-label" htmlFor="companies5">
          ...
          <Accordion.Toggle as={Card} eventKey="2">
            <div className="acod-head">
              <h6 className="acod-title">
                <Link data-toggle="collapse" href="#salary" className="collapsed">
                  Salary
                </Link>
              </h6>
            </div>
              ...
              <div className="acod-content">
                <div className="custom-control custom-radio">
                  <input
                    ...
                    name="radio-currency"
                  />
                  <label className="custom-control-label" htmlFor="salary-op1">
                ...
                <div className="custom-control custom-radio">
                  <input
                    ...
                    name="radio-currency"
                  />
                  <label className="custom-control-label" htmlFor="salary-op2">
                ...
                <div className="custom-control custom-radio">
                  <input
                    ...
                    name="radio-currency"
                  />
                  <label className="custom-control-label" htmlFor="salary-op3">
                ...
                <div className="custom-control custom-radio">
                  <input
                    ...
                    name="radio-currency"
                  />
                  <label className="custom-control-label" htmlFor="salary-op4">
                ...
                <div className="custom-control custom-radio">
                  <input
                    ...
                    name="radio-currency"
                  />
                  <label className="custom-control-label" htmlFor="salary-op5">
            ...
            <div id="job-function" className="acod-body collapse show">
              <div className="acod-content">
                ...
                <div className="custom-control custom-radio">
                  ...
                  >
                    Product Development <span>(798)</span>
                  </label>
                </div>
              </div>
            </div>
              ...
              <div className="acod-content">
                <div className="custom-control custom-radio">
                  <input
                    ...
                    name="radio-industry"
                  />
                  <label className="custom-control-label" htmlFor="industry1">
                    Telecom <span>(5)</span>{" "}
                  </label>
                </div>
                <div className="custom-control custom-radio">
                  <input
                    ...
                    name="radio-industry"
                  />
                  <label className="custom-control-label" htmlFor="industry2">
                    Consulting Services <span>(10)</span>{" "}
                  </label>
                </div>
                <div className="custom-control custom-radio">
                  <input
                    ...
                    name="radio-industry"
                  />
                  <label className="custom-control-label" htmlFor="industry3">
                    Engineering/Projects <span>(15)</span>{" "}
                  </label>
                </div>
                <div className="custom-control custom-radio">
                  <input
                    ...
                    name="radio-industry"
                  />
                  <label className="custom-control-label" htmlFor="industry4">
                    Manufacturing/Industrial <span>(12)</span>
                  </label>
                </div>
                <div className="custom-control custom-radio">
                  <input
                    ...
                    name="radio-industry"
                  />
                  <label className="custom-control-label" htmlFor="industry5">
                    Architecture/Interior Design <span>(8)</span>
                  </label>
                </div>
              </div>
            </div>
