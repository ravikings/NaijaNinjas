                        ...
                        <div className='post-bx'>
                          <div className='d-flex m-b30'>
                            ...
                            <div className='job-post-info'>
                              ...
                              <ul>
                                ...
                                <li>
                                  <i className='fa fa-bookmark-o'></i> {data?.category}
                                </li>
                                <li>
                                  <i className='fa fa-clock-o'></i> Published {data?.created || data?.updated}
                                </li>
                              </ul>
                            </div>
                          </div>
                          <div className='d-flex'>
                            ...
                            <div className='salary-bx d-flex flex-column text-center'>
                              <span>$ {data?.minimum_salary} - $ {data?.maximum_salary}</span>
