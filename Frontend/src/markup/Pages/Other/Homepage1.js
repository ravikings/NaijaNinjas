            ...
            <div className="section-content box-sort-in button-example m-t80">
              <div className="pricingtable-row">
                <div className="row max-w1000 m-auto justify-content-center">
                  <div className="col-sm-12 col-md-8 col-lg-8 p-lr0 ">
                    <div className="pricingtable-wrapper style2 bg-primary text-white active align-items-center">
                      <div className="pricingtable-inner align-items-center">
